...
<div class="dashboard-container">
    ...
    <div class="dashboard-nav-cards">
        ...
        <button type="button" class="nav-card" data-section="submit-request">
            <div class="nav-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button type="button" class="nav-card" data-section="my-requests">
            <div class="nav-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button type="button" class="nav-card" data-section="break-management">
            <div class="nav-card-icon">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
