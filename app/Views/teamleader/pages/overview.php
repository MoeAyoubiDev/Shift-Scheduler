...
<section class="dashboard-surface teamleader-dashboard-page">
    <div class="dashboard-inner">
        ...
        <div class="quick-action-grid">
            <a class="dashboard-card quick-action-card" href="/dashboard/shift-requests.php">
            ...
            <a class="dashboard-card quick-action-card" href="/dashboard/weekly-schedule.php">
            ...
            <a class="dashboard-card quick-action-card" href="/dashboard/manage-employees.php">
            ...
            <a class="dashboard-card quick-action-card" href="/dashboard/performance.php">
                <span class="quick-action-icon accent-purple">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
